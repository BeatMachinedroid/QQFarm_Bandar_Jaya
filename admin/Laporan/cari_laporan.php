<div class="card card-warning">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fa fa-edit"></i> Laporan Harian
        </h3>
    </div>
    <form action="?page=laporan-harian" method="post">
        <div class="card-body">
            ...
            <div class="card-footer">
                <input type="submit" name="Simpan" value="Cari Laporan Harian" class="btn btn-info">
